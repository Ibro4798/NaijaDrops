  ...
  return (
    <main className="bg-charcoal-50 min-h-screen pt-24 pb-32">
      <div className="max-w-2xl mx-auto px-4 sm:px-6">
            ...
            <div className="flex justify-between items-start">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <div className="text-sm text-charcoal-500 font-medium">{driverData.vehicle}</div>
                    </div>
                </div>
                <div className="text-right">
                    <div className="text-xs text-charcoal-500 font-bold uppercase tracking-widest mb-1">Total Due</div>
                    <div className="font-black text-2xl text-emerald-600">₦{driverData.price}</div>
                </div>
            </div>
        </div>
        ...
        {/* Route Section */}
        <div className="bg-white rounded-[2rem] p-6 shadow-sm border border-gray-100 mb-6">
            <h3 className="text-sm font-bold text-charcoal-400 uppercase tracking-widest mb-4">Route Details</h3>
            
            <div className="flex gap-4 mb-2">
                <div className="flex flex-col items-center mt-1">
                    <div className="w-3 h-3 rounded-full bg-charcoal-800 ring-4 ring-gray-100 mt-1"></div>
                    <div className="w-0.5 h-16 bg-gray-200 my-1"></div>
                    <div className="w-3 h-3 rounded-full bg-emerald-500 ring-4 ring-emerald-50 mb-1"></div>
                </div>
                <div className="flex-1">
                    <div className="mb-6">
                        <div className="text-xs font-bold text-charcoal-500 uppercase tracking-widest mb-1">Pickup</div>
                        <div className="font-bold text-charcoal-900 bg-gray-50 px-3 py-2 rounded-xl">{orderData.pickup.name}</div>
                    </div>
                    <div>
                        <div className="text-xs font-bold text-emerald-600 uppercase tracking-widest mb-1">Dropoff</div>
                        <div className="font-bold text-charcoal-900 bg-emerald-50 border border-emerald-100 px-3 py-2 rounded-xl">{orderData.dropoff.name}</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className="bg-white rounded-[2rem] p-6 shadow-sm border border-gray-100 mb-6">
             ...
             <div className="grid grid-cols-2 gap-4 bg-gray-50 p-4 rounded-xl">
                 <div>
                     ...
                     <div className="font-bold text-charcoal-900 text-sm">{orderData.category}</div>
                 </div>
                 <div>
                     <div className="text-[10px] text-gray-500 font-bold uppercase tracking-widest mb-1">Size</div>
                     <div className="font-bold text-charcoal-900 text-sm">{orderData.size} Box</div>
                 </div>
                 <div className="col-span-2 pt-3 border-t border-gray-200">
                     ...
                     <div className="font-bold text-charcoal-900 text-sm">{orderData.receiver.name} • {orderData.receiver.phone}</div>
                 </div>
             </div>
        </div>
      </div>
